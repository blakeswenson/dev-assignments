...
from checkout_screen import show_customer_info_screen, show_payment_screen
...
def show_cart_screen(main_frame, clear_frame, go_back, show_checkout_screen, cart):
    ...
    tk.Button(main_frame, text="Cancel", font=("Helvetica", 12), bg="gray", fg="white", command=go_back).pack()
